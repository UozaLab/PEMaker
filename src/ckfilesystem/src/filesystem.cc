...
namespace ckfilesystem
{
    ...
    bool FileSystem::add_boot_image_no_emu(const ckcore::tchar *full_path,const ckcore::tchar *internal_path,bool bootable,
                                           ckcore::tuint16 load_segment,ckcore::tuint16 sec_count)
    {
        return eltorito_.add_boot_image_no_emu(full_path,internal_path,bootable,load_segment,sec_count);
    }
