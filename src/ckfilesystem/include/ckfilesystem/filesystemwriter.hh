...
namespace ckfilesystem
{
    ...
    private:
		...
		bool extended_mode;
	    ckcore::tstring catalog_file_path;
	    ckcore::tstring catalog_internal_path;
    ...
    public:
	    ...
	    void set_catalog_file_path(const ckcore::tchar* _catalog_file_path, const ckcore::tchar* _catalog_internal_path)
        {
			catalog_file_path = _catalog_file_path;
